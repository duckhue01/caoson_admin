...
function TeamIcon({className}) {
    return(
        <svg 
            ...
            preserveAspectRatio="xMidYMid meet" data-bbox="20 20 160 160" viewBox="20 20 160 160" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img" aria-labelledby="svgcid--d4mkro-h6f6ss"><defs><style dangerouslySetInnerHTML={{__html: "#comp-k0exgn52 svg [data-color=\"1\"] {fill: #9A8A78;}" }} /></defs><title id="svgcid--d4mkro-h6f6ss" />
            <g>
